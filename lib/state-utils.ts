...
/**
 * Default shipping cost per square foot if state not found
 */
export const DEFAULT_SHIPPING_COST = 0.35

/**
 * Base shipping cost added to all shipping calculations
 */
export const BASE_SHIPPING_COST = 230
